...
export default async function AuditLogsPage() {
    ...
    return (
        <div className="p-8 max-w-6xl mx-auto mb-20 animate-in fade-in zoom-in duration-500">
            <header className="mb-10">
                ...
                <h1 className="text-4xl font-extrabold tracking-tight">Audit Logs & Integrity Verification Trails</h1>
